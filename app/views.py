...
UPLOAD_PATH = '/content/drive/MyDrive/car-damage-detecting-MaskRCNN-main/static/uploads/'
UPLOAD_PRED_PATH = '/content/drive/MyDrive/car-damage-detecting-MaskRCNN-main/static/prediction/'
